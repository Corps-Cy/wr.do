...
export async function POST(req: NextRequest) {
  try {
    ...
    const newDomain = await createDomain({
      ...
      dns_provider_type: target_domain.dns_provider_type || undefined,
      ...
      aliyun_access_key_id: target_domain.aliyun_access_key_id,
      aliyun_access_key_secret: target_domain.aliyun_access_key_secret,
      aliyun_region: target_domain.aliyun_region,
      aliyun_domain_name: target_domain.aliyun_domain_name,
      aliyun_record_types: target_domain.aliyun_record_types,
